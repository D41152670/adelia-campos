...
function videoBackgroundSize(){var t=56.25;0<$(".video-bg").length&&$(".video-bg").each(function(){var e,i,a=100*$(this).height()/$(this).width();t<=a?(e=100*$(this).height()/t+50,i=$(this).height()+50,$(this).find(".video-container").height(i),$(this).find(".video-container").width(e)):(e=$(this).width()+50,i=$(this).width()*t/100+50,$(this).find(".video-container").width(e),$(this).find(".video-container").height(i),console.log(i))})}$(document).ready(function(){videoBackgroundSize()}),$(window).scroll(function(){50<$(this).scrollTop()?$("#menu-site").addClass("menu-scroll"):$("#menu-site").removeClass("menu-scroll")});var equipe=new Swiper(".swiper-equipe",{slidesPerView:2.5,spaceBetween:15,speed:1e3,breakpoints:{360:{slidesPerView:1.5},576:{slidesPerView:2.5},640:{slidesPerView:2.5},768:{slidesPerView:2.5},992:{slidesPerView:1.8},1024:{slidesPerView:1},1200:{slidesPerView:2.5},1366:{slidesPerView:2.5}},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}}),swiper=new Swiper(".area-atuacao__slider",{spaceBetween:15,slidesPerView:1.5,freeMode:!0,watchSlidesVisibility:!0,watchSlidesProgress:!0}),swiper=new Swiper(".swiper-blog",{slidesPerView:1,spaceBetween:10,pagination:{el:".swiper-pagination",clickable:!0},autoplay:{delay:2500,disableOnInteraction:!1},breakpoints:{370:{slidesPerView:1.5},576:{slidesPerView:2.5},640:{slidesPerView:2.5},768:{slidesPerView:2.5,spaceBetween:40},992:{slidesPerView:2.5},1024:{slidesPerView:5,spaceBetween:50}}});$(document).on("click",".btn-menu-responsive",function(e){$(this).addClass("openMenu"),$(".body-menu-responsive").addClass("open"),$("body").addClass("menu-ativo")}),$(document).on("click",".openMenu",function(e){$(this).removeClass("openMenu"),$(".body-menu-responsive").removeClass("open"),$("body").removeClass("menu-ativo")}),$(".navbar-site__link").on("click",function(e){$(".body-menu-responsive").removeClass("open"),$(".btn-menu-responsive").removeClass("openMenu"),$("body").removeClass("menu-ativo")}),$("a#videoBanner").fancybox(),$("[data-fancybox]").fancybox({youtube:{controls:0,showinfo:0},vimeo:{color:"f00"}});let atuacaoMenu=document.querySelectorAll(".area-atuacao__js"),atuacaoContent=document.querySelectorAll(".area-atuacao__content");function displayContent(t){atuacaoContent.forEach(function(e,i){var a=e.dataset.idcontent;e.classList.contains("area-atuacao__content--active")&&e.classList.remove("area-atuacao__content--active"),t==a&&document.getElementById(t).classList.add("area-atuacao__content--active")})}function removeActiveButton(a){atuacaoMenu.forEach(function(e,i){e.classList.contains("area-atuacao__links--active")&&e.classList.remove("area-atuacao__links--active"),a.classList.add("area-atuacao__links--active")})}atuacaoMenu.forEach(function(e,i){e.addEventListener("click",function(e){var i=this.dataset.target;removeActiveButton(this),displayContent(i),e.preventDefault()})});